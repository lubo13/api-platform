...
class PatchScheduleTest extends ApiTestCase
{
    ...
    public function testPatchAllDataSucceeds(): void
    {
    ...
    public function testPatchServiceSucceeds(): void
    {
        $serviceIri = $this->findIriBy(Service::class, ['name' => 'Carwash 1']);
        $datetime = new \DateTime();
        foreach (self::$schedules as $k => $schedule) {
    ...
    public function testPatchVehicleSucceeds(): void
    {
        $vehicleIri = $this->findIriBy(Vehicle::class, ['model' => '520']);
        $datetime = new \DateTime();
        foreach (self::$schedules as $k => $schedule) {
